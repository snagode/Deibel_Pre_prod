...
{
    [SampleManagerTask(nameof(FinanceApiBilled10th))]
    public class FinanceApiBilled10th : SampleManagerTask, IBackgroundTask
    {
        ...
        public void Launch()
        {
          ...
          //  q.AddEquals(BilledViewPropertyNames.BillingStatus, "N");
            ...
            else
            {
                ...
                if (val == "Success")
                {
                    var path = Library.Environment.GetFolderList("Smp$FinanceBilledFiles");
        ...
        private string createCSv(IEntityCollection data)
        {
            try
            {
                ...
                File.WriteAllText(@"C:\Thermo\SampleManager\Server\SMUAT\FinanaceApiBilled\Logs\Data\" + logFile + ".csv", csv.ToString());
        ...
        public void email_send(FileInfo file)
        {
            ...
            try
            {
                ...
                File.Move(file.FullName, @"C:\Thermo\SampleManager\Server\SMUAT\FinanaceApiBilled\Logs\Data\MovedFile\" + file.Name);
        ...
        public void LogInfo(string message)
        {
            ...
            var file = Library.File.GetWriteFile("Smp$FinananceBilledLogfile", logFile);
