...
namespace Customization.Tasks
{
    ...
    public abstract class DeibelSampleAdminBaseTask : SampleManagerTask
    {
        ...
        private Credit_Hold _creditHold;
        ...
        public static IEntity _jobHeader1;
        ...
        // var type =   m_Form.GridJobProperties.Columns[4].GetType();
            return samples;
        }
        ...
        void ActionButtonApply_BeforeAction(object sender, ControlCancelEventArgs e)
        {
            ...
            if (count > 1)
            {
                m_Form.ActionButtonApply.Enabled = false;
            }
            ThreadPool.QueueUserWorkItem(state =>
            {
                try
        ...
        void GridCellChanged()
        {
            ...
            if (_creditHold == null)
            {
                _creditHold = new Credit_Hold();
            }
            if (cell.PropertyName=="CustomerId")
            {
                _creditHold.HandleGridCellChanged(cell, this, entity, m_Form);
            }
