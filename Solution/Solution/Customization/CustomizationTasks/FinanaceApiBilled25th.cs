...
{
    [SampleManagerTask(nameof(FinanaceApiBilled25th))]
    public class FinanaceApiBilled25th : SampleManagerTask, IBackgroundTask
    {
        ...
        public void Launch()
        {
            ...
            var q = EntityManager.CreateQuery(BilledViewBase.EntityName);

           // q.AddEquals(BilledViewPropertyNames.JobStatus, "A");

           // q.AddEquals(BilledViewPropertyNames.BillingStatus, "N");

            q.AddLessThan(BilledViewPropertyNames.DateAuthorised, LessThan10Days);
            ...
            else
            {
                ...
                if (val == "Success")
                {
                    var path = Library.Environment.GetFolderList("Smp$FinanceBilledFiles25th");
        ...
        private string createCSv(IEntityCollection data)
        {
            try
            {
                ...
                foreach (BilledViewBase i in data)
                {
                ...
                File.WriteAllText(@"C:\Thermo\SampleManager\Server\SMUAT\FinanaceApiBilled25th\Logs\Data\" + logFile + ".csv", csv.ToString());
        ...
        public void email_send(FileInfo file)
        {
            ...
            try
            {
                using (MailMessage mail = new MailMessage())
                {
                    ...
                    query.AddEquals(NotificationsLimsPropertyNames.EntryId, "BILLED 21ST");
                ...
                File.Move(file.FullName, @"C:\Thermo\SampleManager\Server\SMUAT\FinanaceApiBilled25th\Logs\Data\MovedFile\" + file.Name);
        ...
        public void LogInfo(string message)
        {
            ...
            var file = Library.File.GetWriteFile("Smp$FinananceBilledLogfile25th", logFile);
