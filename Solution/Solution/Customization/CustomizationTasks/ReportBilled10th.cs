...
{
    [SampleManagerTask(nameof(ReportBilled10th))]
    public class ReportBilled10th : SampleManagerTask, IBackgroundTask
    {
        ...
        public void Launch()
        {
          ...
          //  q.AddEquals(NotBilledViewPropertyNames.BillingStatus, "B");
            ...
            else
            {
                ...
                if (val == "Success")
                {
                    var path = Library.Environment.GetFolderList("Smp$FinanceFilesReportBilled10th");
        ...
        private string createCSv(IEntityCollection data)
        {
            try
            {
                ...
                File.WriteAllText(@"C:\Thermo\SampleManager\Server\SMUAT\ReportBilled10th\Logs\Data\" + logFile + ".csv", csv.ToString());
        ...
        public void email_send(FileInfo file)
        {
            ...
            try
            {
                using (MailMessage mail = new MailMessage())
                {
                    ...
                    query.AddEquals(NotificationsLimsPropertyNames.EntryId, "NOT BILLED 6TH");
        ...
        public void LogInfo(string message)
        {
            ...
            var file = Library.File.GetWriteFile("Smp$FinananceLogfileReportBilled10th", logFile);
