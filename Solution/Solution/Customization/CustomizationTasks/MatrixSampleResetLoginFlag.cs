...
{
    [SampleManagerTask(nameof(MatrixSampleResetLoginFlag))]
    public class MatrixSampleResetLoginFlag : SampleManagerTask
    {

        protected override void SetupTask()
        {
            var selectedItem = (SampleBase)Context.SelectedItems[0];
            var selectedItems = Context.SelectedItems.Cast<SampleBase>().ToList();
