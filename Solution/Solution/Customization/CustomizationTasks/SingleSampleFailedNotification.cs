...
{
    [SampleManagerTask(nameof(SingleSampleFailedNotification), "WorkflowCallback")]
    public class SingleSampleFailedNotification : SampleManagerTask
    {
        ...
        protected override void SetupTask()
        {
            ...
            PostRequest(url, obj1);
            Exit(true);
        }

        public void PostRequest(string url, dynamic obj)
        {
